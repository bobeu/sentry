...
export function capabilitiesSummary(username: string) {
  ...
  return [
    "I'm Sentry — your intelligent AI Telegram employee (not a shallow command bot).",
    "",
    "I can:",
    "• Read group context and answer with agentic reasoning (admin or privacy-off for full visibility)",
    "• Answer from FAQs + knowledge base — only what you asked (no FAQ dumps on hi/thanks)",
    "• Welcome members, moderate spam, and run admin tools (/ban /mute /unmute)",
    "• Host polls, trivia, games, fun/comics & Twitter/X campaigns when the employer enables them",
    "• Judge quiz answers instantly (inline buttons or reply/tag) and track your points",
    "• Optional cash rewards from a separate RewardAccount — withdraw by tagging me with your 0x",
    "• /mystatus & /points — interactive hub for balances, games, leaderboard, pending cash",
    "• Announcements, birthdays, summaries, handovers, escalations & living playbooks",
    "• Secretary Mode (Telegram Business → Chatbots) + employer DM menu",
    "• Distinctive, well-formatted replies so I stand out in the chat",
    "",
    "DM tip: type / for commands, or /menu for action buttons.",
    `Try in a group: ${tag} what is this group about?`,
    "Group tip: /mystatus or /points · say start quiz / create poll when engagement is on.",
    "Commands (DM): /menu /status /report /groups /mywallet /balance",
    "Commands (group): /help /mystatus /points /poll /trivia /campaign /ban /mute /announce /birthday /remember",
  ].join("\n");
}
