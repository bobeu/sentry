...
export const GROUP_BOT_COMMANDS = [
  ...
  { command: "poll", description: "Start a group poll (when enabled)" },
  { command: "trivia", description: "Start learn-and-earn trivia" },
  { command: "campaign", description: "Start social campaign with URL" },
  { command: "points", description: "Your points, games & rewards menu" },
  { command: "mystatus", description: "Interactive status: points, games, cash" },
